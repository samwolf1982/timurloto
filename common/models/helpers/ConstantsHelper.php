...
//    const PARSE_BASE_URL='http://89.108.65.253';
    ...
    const AVELABLE_MAKRETS = [
        ...
        // новые добавлено в ручную
        '15323' => 'Prohod', // Обладатель кубка добавили
        '12449'=>'ForaBySets',  // тенис фора по сетам
        '12522'=>'TotalBySets',  // тенис тотал по сетам
        '15084'=>'SetsMatch',  // тенис сет матчк
        '12516'=>'BestResultPeriod',  // баскетбол самый результативный период
        '14584'=>'HalfMatches',  // баскетбол половина матча
        '12441'=>'WinInMatch',  // хокей победа в матче
