...
//    const PARSE_BASE_URL='http://89.108.65.253';
    ...
    const AVELABLE_MAKRETS = [
        ...
        '12449',  // тенис фора по сетам
        '12522',  // тенис тотал по сетам
        '15084',  // тенис сет матчк
        '12516',  // баскетбол самый результативный период
        '14584',  // баскетбол половина матча
        '12441',  // хокей победа в матче
