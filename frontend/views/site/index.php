                                        ...
                                        <div class="tab-panel active" id="tab1">
                                            ...
                                            <div class="tab-panel-wrapper">
                                                <div class="tab-panel-inner">
                                                   ...
                                                   <?php if(0){ ?>
                                                       <p>
                                                           Еженедельные турниры прогнозистов.
                                                       </p>
                                                       <p> Каждую неделю проходит турнир, где лучшие прогнозисты выигрывают реальные деньги.</p>
                                                       <p>    Проект только открылся и наша цель с развитием поднимать призовые турниров симметрично с количеством участников, при этом добавлять множество разновидностей турниров.</p>
                                                       <p>  Данная идея позволит собрать лучших в своём деле в одном месте, которые будут бороться за круглые суммы.</p>
                                                       <p>  Участие в турнире принять легко, достаточно просто оставить прогноз и все, никаких вложений.</p>
                                                   <?php }  ?>
<p>Еженедельные турниры прогнозистов. Каждую неделю проходит турнир, где лучшие прогнозисты выигрывают реальные деньги. Проект только открылся и наша цель с развитием поднимать призовые турниров симметрично с количеством участников, при этом добавлять множество разновидностей турниров. Данная идея позволит собрать лучших в своём деле в одном месте, которые будут бороться за круглые суммы. Участие в турнире принять легко, достаточно просто оставить прогноз и все, никаких вложений.</p>
                                                                     </div>
                                        ...
                                        <div class="tab-panel" id="tab2">
                                            ...
                                            <div class="tab-panel-wrapper">
                                                ...
                                                <p>    Оставляйте свои прогнозы за секунды.</p>
                                                <p>    Это очень просто, так как сайт полностью имитирует реальную БК и имеет широкий выбор событий.</p>
                                                <p>    Наша платформа станет для вас настоящей тренировочной площадкой, где вы сможете оставлять прогнозы на основные исходы, 1-й тайм, 2-й тайм, желтые карты, угловые, удары, фолы и т. д. и делать это за секунды экономя свое время.</p>
                                        ...
                                        <div class="tab-panel" id="tab3">
                                            ...
                                            <div class="tab-panel-wrapper">
                                                <div class="tab-panel-inner">
                                                  <p> Варианты для профи: турниры, предоставление доступов к закрытым прогнозам, создание команды.</p>
                                                   <p> Наш проект не берет никакие комиссии со сделок и в целом в них не вникает.</p>
                                                  <p>  Мы - это просто площадка с инструментами для вас.</p>

                                                  <p>  Для новичков: доступ к множеству бесплатных прогнозов от профи, каждый дань и бесплатно.</p>
                                                   <p> Развитие в сфере ставок без потери реальных денег.</p>
                                                </div>
                                                <div class="image-tab-wrapper">
                                        ...
                                        <div class="tab-panel" id="tab4">
                                            ...
                                            <div class="tab-panel-wrapper">
                                                <div class="tab-panel-inner">
                                                   <p> Профессиональный личный кабинет.</p>
                                                  <p>  Наш кабинет отображает полную статистику ваших прогнозов, сортируя по времени и по созданным вами же спискам.</p>
                                                  <p>  Вы имеете возможность видеть насколько вы эффективны на дистанции, насколько вы хороши в отдельных видах спорта, командах, стратегиях и т.д.</p>
                                                </div>
                                                <div class="image-tab-wrapper">
                                        ...
                                        <div class="tab-panel" id="tab5">
                                            ...
                                            <div class="tab-panel-wrapper">
                                                <div class="tab-panel-inner">
                                                  <p>  Этот вопрос очень важен, так как в наши дни интернет полностью пропитан капперами-мошенниками, которые используют людей как ресурс набивая свои карманы.</p>
                                                   <p> Мы меняем эту тенденцию. Используя нашу систему невозможно быть обманутым, ведь аккаунт каждого игрока открыт, полная статистика каждого всегда на виду, статистику подкрутить нельзя, прогнозы удалять нельзя, закрытые прогнозы после завершения матча открываются всем.</p>
                                                   <p> Все просто.</p>
                                                </div>
                                                <div class="image-tab-wrapper">
