                                ...
                                <div class="faq-list collapse-wrapper">
                                    ...
                                    <div class="collapse-item">
                                        ...
                                        <div class="collapse-item-body" id="faq7">
                                            <p>+ Пользователь должен сделать минимум 10 прогнозов, для определения уровня. Уровень аккаунта зависит от вашего профита и имеет 21 показатель</p>
                        ...
                        <div class="choose-bet-inner">
                            ...
                            <div class="faq-wrapper">
                                <div class="faq-list collapse-wrapper">
                                    <div class="collapse-item">
                                        <div class="collapse-item-head">
                                            <a href="#faq1-t" data-toggle="collap">Как я могу участвовать в турнирах?</a>
                                        </div>
                                        <div class="collapse-item-body" id="faq1-t">
                                            <p>
                                                - Для того, чтобы учавствовать в турнирах Вам необходимо зарегистрироваться на сайте и оставить свой первый прогноз. Система автоматом распределит Вас во все наши турниры.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="collapse-item">
                                        ...
                                        <div class="collapse-item-body" id="faq2-t">
                                            <p>
                                                - Еженедельный турнир проходит каждую неделю, его обновление проходит в ночь с воскресенья на понедельник. При этот турнирная таблица обновляется, а также обновляется Ваш недельный профит в личном кабинете.
                                            </p>
