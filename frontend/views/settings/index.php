                        ...
                        <div class="column-12 input-row-wrapper">
                            <div class="avatar-row">
                                <div class="avatar-inner">
                                    <div class="round-avatar" style="background-image: url(images/avatar-placeholder.svg);"></div>
                                    <div class="edit-avatar">
                                        <input type="file" id="avatr-edit">
                            ...
                            <div class="input-row">
                                <input type="text" value="Sokol_567">
                                <label class="placeholder">Никнейм</label>
                            </div>
                            <div class="input-row">
                                <input type="text" value="alexandr.sokol@gmail.com">
                                <label class="placeholder">Email</label>
                            </div>
                            <div class="input-row">
                                <input type="password" value="ddasdasdasdas">
                                <label class="placeholder">Текущий пароль</label>
                            </div>
                            <div class="input-row">
