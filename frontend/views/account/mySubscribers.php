            ...
            <div class="head-choose">
                <div class="tabs-modal-trigger">
                    <ul class="tabs-nav">
                        <li class="active">
                            <div class="head-choose">
                                <h2>Мои Подписчики <span class="muted-text"><?=$countSubsMail?></span></h2>
                            </div>
                            ...
                            <div class="list-block-subscribe">
                                <div class="list-block-subscribe-inner" data-simplebar data-simplebar-auto-hide="true">
                                    <div class="for-scroll">
                                        ...
                                        <?php if( empty( $mySubscribers)){  ?>
                                            <div class="subscribe-item user-access-item" style="justify-content: center;">
                                                <p style="color: black;"> На вас еще никто не делел подписку</p>
                                            </div>
                                        <?php }else{  ?>
                                            <?php
                                            /** @var Subscriber $us */
                                            foreach ($mySubscribers as $sub) { ?>
                                                <div class="subscribe-item">
                                                    <div class="rate-avatar">
                                                        ...
                                                        <div class="avatar-user">
                                                            <img src="/<?=$sub->userown->imguse->avatar?>" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="name-block">
                                                        <h5><a href="<?=Url::to(['/account/'.$sub->userown->id]);?>"><?=$sub->userown->username?></a></h5>
                                                    </div>
                                                    <div class="btn-subscibe-block">
                                                        <a href="<?=Url::to(['/account/'.$sub->userown->id]);?>" class="btn-subscribe">
                                                            <?php if($sub->userown->isSubscriberMailfront()){ ?>
                                                                <span class="shown-text">Отписаться</span>
                                                                <span class="hidden-text">Подписаться</span>

                                                            <?php }else{ ?>
                                                                <span class="hidden-text">Отписаться</span>
                                                                <span class=" shown-text">Подписаться</span>
                                                            <?php }  ?>
